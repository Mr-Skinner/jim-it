...
const Home: NextPage = () => {
  return (
    <>
      <h1 className="fixed bg-emerald-300 text-[5rem] pl-12 font-semibold -tracking-[.1em] text-white sm:text-[5rem]">
        Jim It!
      </h1>
      <main className="flex min-h-screen flex-col gap-12 bg-emerald-300 font-raleway">
        ...
        <div className="mx-auto my-[25%] flex w-4/5 grow flex-col items-center justify-start gap-8">
          <div className="container flex-col justify-start bg-white">
            <StatOneLiner title={"Last workout"} data={"19/05/2023"} upDown={""}/>
            <hr className="border-emerald-400" />
            <StatOneLiner title={"Workouts this month"} data={"8"} upDown={"down"}/>
          </div>
          <div className="flex w-full grow justify-between gap-4">
            <div className="container p-2">
              ...
              <p className="italic text-white text-sm font-normal">All figures measured in kilograms (kg).</p>
            </div>
